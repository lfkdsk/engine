...
vars = {
  ...
  'skia_revision': 'cb48a2e421fa2e3524179e91199742ceebd7d532',
  # END
  ...
  'dart_revision': 'bda46c9a7195c7cc39a6e3bd3e8f10fdeb33c73c',
...
deps = {
  ...
  'src': 'ssh://git@code.byted.org/tech_client/buildroot' + '@' + 'd109bfb9a1e628498378e19ed9e30cd5b244e30a',
